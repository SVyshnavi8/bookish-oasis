...
const TS360 = () => {
  ...
  return (
    <MainLayout>
      ...
      >
        <div className="editorial-container">
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-20 items-center">
            ...
            <div
              className="lg:col-span-5 aspect-[5/6] rounded-2xl overflow-hidden shadow-lg"
              data-aos="zoom-in"
              data-aos-delay="400"
            >
              <img
      ...
      <section
        className="py-14 bg-secondary/10"
        data-aos="fade-up"
      >
        <div className="editorial-container">
      ...
      >
        <div className="editorial-container text-center space-y-6">
          ...
          <div className="flex justify-center">
            ...
            >
              <Layers className="w-7 h-7 text-[#2aa6a6]" />
            </div>
          </div>
          ...
          {/* Description */}
          <p className="editorial-body max-w-3xl mx-auto text-center leading-relaxed">
